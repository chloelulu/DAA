func <- function(part, method, paras) {
  ...
  # 23 methods totally
  methods_funs <- list("fastANCOM" = "fastANCOM.wrapper",'ZicoSeq'= "ZicoSeq.wrapper", 'Rarefy'= "Rarefy.wrapper", 'Aldex2'= "Aldex2.wrapper", 'Omnibus'="Omnibus.wrapper", 'ANCOM2'="ANCOM2.wrapper", 'ZicoSeq0'= "ZicoSeq0.wrapper",'ZicoSeq1'= "ZicoSeq1.wrapper",
                       ...
                       'edgeR'="edgeR.wrapper", 'edgeR.gmpr'="edgeR.gmpr.wrapper", 'edgeR.Wrench'="edgeR.Wrench.wrapper","ZINQ"="ZINQ.wrapper",
                       ...
                       "ZicoSeq3"="ZicoSeq3.wrapper", "IFAA" = "IFAA.wrapper",
