func <- function(part, method, paras) {
  ...
  # 23 methods totally
  methods_funs <- list("fastANCOM" = "fastANCOM.wrapper",'ZicoSeq'= "ZicoSeq.wrapper", 'Rarefy'= "Rarefy.wrapper", 'Aldex2'= "Aldex2.wrapper", 'Omnibus'="Omnibus.wrapper", 
                       'ANCOM2'="ANCOM2.wrapper", 'ZicoSeq0'= "ZicoSeq0.wrapper",'ZicoSeq1'= "ZicoSeq1.wrapper",'ZicoSeq2'= "ZicoSeq2.wrapper",
                       ...
                       'DESeq2'="DESeq.wrapper", 'DESeq2.Wrench'="DESeq.Wrench.wrapper", 'DESeq2.gmpr'="DESeq.gmpr.wrapper",'ZINQ'="ZINQ.wrapper",
                       'Wilcox'='wilcox.wrapper' , 'Wilcox.Wrench'='wilcox.Wrench.wrapper' , 'Wilcox.gmpr'='wilcox.gmpr.wrapper',
                       'edgeR'="edgeR.wrapper", 'edgeR.gmpr'="edgeR.gmpr.wrapper", 'edgeR.Wrench'="edgeR.Wrench.wrapper","IFAA" = "IFAA.wrapper",
                       'MSeq2.Wrench'="metagenomeSeq2.Wrench.wrapper", 'MSeq2'="metagenomeSeq2.wrapper",'MSeq2.gmpr'="metagenomeSeq2.gmpr.wrapper",
                			'linda'="linda.wrapper",'eBayt'="eBayt.wrapper",'eBayW'="eBayW.wrapper",'Aldex2we'="Aldex2we.wrapper","ZicoSeq3"="ZicoSeq3.wrapper",
                			'ttest.gmpr' = 'ttest.gmpr.wrapper','ttest.Wrench' = 'ttest.Wrench.wrapper','mbzinb' = "mbzinb.wrapper","Rarefyttest"="Rarefyttest.wrapper")
