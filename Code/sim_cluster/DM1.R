...
SimulateSeq <- function (
  ...
  grp.ratio = 1,covariate.eff.sd = 0, 
  # Confounder effect
  ...
  # Sequence depth
  depth.mu = 10000, depth.theta = 5,  depth.conf.factor = c('none','DL1','DL2','DL3','DL4','DL5')
  ...
  covariate.eff.means = c(0, 0.6, 1.3, 1.7, 2.2, 2.6)#c(0, 0.4, 0.8, 1.2, 1.6, 2)
  ...
  idx.sample <- sample(colnames(model.paras$otu.tab), nSam)
