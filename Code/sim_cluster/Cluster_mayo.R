clsapply <- function(dat, func, df=NULL, tempdir="~/project/tempZ",
  ...
  txt <- paste('
               ...
               '\n date()
                        ...
                        pkg <- c("Maaslin2","LinDA","GMPR","ZIBBSeqDiscovery","RDB","mbzinb","eBay","modeest","ANCOMBC","aod","phyloseq","reshape","corncob","MASS","readr","DESeq2", "ALDEx2", "metagenomeSeq", "edgeR", "GUniFrac", "grDevices", "dirmult", "exactRankTests","nlme", "dplyr", "magrittr", "tidyr", "protoclust", "ggplot2", "compositions","rmutil","tibble","reticulate","dacomp","LDM","Wrench","RioNorm2")
